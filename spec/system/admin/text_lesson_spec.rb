...
describe 'text_lessons management' do
  it 'visit text_lesson details' do
    ...
    expect(page).to have_text(text_lessons.first.lesson_body)
  ...
  it 'create a text lesson' do
    ...
    fill_in 'Conteúdo', with: 'Lorem ipsum dolor sit amet, consectetur elit, sed do eiusmod tempor incididunt.'
    click_on 'Criar Aula'
    ...
    expect(page).to have_text('Lorem ipsum dolor sit amet, consectetur elit, sed do eiusmod tempor incididunt.')
  end
  ...
  it 'can edit text lesson' do
    ...
    fill_in 'Conteúdo', with: 'Artigo explicando guard clause'
